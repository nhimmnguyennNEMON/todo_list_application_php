                ...
                <div class="card-body">
                    ...
                    <form action="" method="" id="myForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" minlength="6" maxlength="25" name="username" id="username" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" minlength="6" maxlength="25" name="password" id="password" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" class="form-control" minlength="6" maxlength="25" name="confirmPassword" id="confirmPassword" required>
                            <span class="text-danger" id="messError_confirmPassword" style="display: none">...</span>
                        </div>
                        <!--Captcha item-->
                        ...
                        <p class="text-end">Already a member?
                            <a href="../view/signin_view.php" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover fw-bolder">Sign In</a>
                        </p>
                        <div class="text-center justify-content-between">
                            <button type="reset" class="btn btn-outline-secondary mx-2">Reset</button>
                            <button type="submit" id="submitButton" class="btn btn-primary fw-bolder mx-2">Sign Up</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        $('#myForm').submit(function(event) {
            ...
            $('#alertMessager').hide();
            $('#messError_confirmPassword').hide();
            ...
            $.ajax({
                type: 'POST',
                url: '../controllers/signup_handler.php',
                data: {username: username, password: password, confirmPassword: confirmPassword, captcha: captcha},
                success: function(response) {
                    try {

                        $('#username').val(this.data.username);
                        $('#password').val(this.data.password);
                        $('#confirmPassword').val(this.data.confirmPassword);
